// ============================================================================
// НАЗВА ФАЙЛУ: nutrient_config_service.dart
// ПРОЄКТ: Моя дієта
// ПРИЗНАЧЕННЯ: Глобальний сервіс налаштувань кольорів та іконок нутрієнтів
// ============================================================================
...
// ----------------------------------------------------------------------------
// [ВУЗОЛ 1]: СЕРВІС НАЛАШТУВАНЬ НУТРІЄНТІВ (NutrientConfigService)
// ----------------------------------------------------------------------------
class NutrientConfigService {
  ...
  // --------------------------------------------------------------------------
  // [ВУЗОЛ 1.2]: РЕАКТИВНІ НАЛАШТУВАННЯ НУТРІЄНТІВ (ValueNotifier configs)
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // [ВУЗОЛ 1.3]: МЕТОД ОНОВЛЕННЯ КОНФІГУРАЦІЇ НУТРІЄНТА (updateNutrient)
  // --------------------------------------------------------------------------
  /// Метод для екрана Налаштувань (зміна кольору або іконки)
